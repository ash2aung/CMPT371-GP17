...
/**
 * Represents some entity in the maze, interactable objects (Cat, Cheese, Mouse)
 * will all inherit from
 * this class. This class will distinguish between wall and path objects using
 * the passable field.
 * member col: this object's current column in the maze
 * member row: this object's current row in the maze
 * member passable: states whether the object can be passed through (Cat,
 * Cheese, Path) or not (Wall)
 * member visible: states whether the object is visible to the player (within or
 * was within range of the mouse)
 */
public class MazeObject {
     ...
     * Creates an object with only one parameter: passable. For Walls, it's false.
     * For Paths, it's tru
     * The column and row do not need to be saved as neither need to be used for
     * anything for Paths or Walls
     * 
     ...
     * Creates an object with 2 parameters: passable (Wall=true, Path=false) and
     * visible (if it was visible to the
     ...
     * Used when a new Cheese needs to be placed, when the player (mouse) moves, or
     * when a Cat moves
     * 
     ...
     * 
     * @return passable: Whether the Mouse can move into the same space as this
     *         object
     */
     ...
     * 
     * @param passable: Whether the Mouse can pass through this object (Path) or not
     *                  (Wall)
     */
